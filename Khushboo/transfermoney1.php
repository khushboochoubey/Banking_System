...
<div class="container">
        ...
        <br>
            <div class="row">
                ...
                ?>
                    <tr style="color : white;">
                        ...
                        <td><a href="selecteduserdetail1.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style="background-color : #e6b31a;" style="border-radius:0%;">Proceed</button></a></td> 
                    </tr>
                <?php
                $cnt=$cnt+1;
                    }
         ...
         <footer class="text-center mt-5 py-2">
            <p>&copy 2023 Made by<b>Khushboo Choubey</b> </p>
         </footer>
